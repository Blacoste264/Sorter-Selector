...
document.getElementById('mergerBtn').onclick = function handleClickEvent(ev) {
    ...
    + ' The first function named as mergeSort is actually a divide function. where an array is divided into two. '
    + ' this is just merging two sorted array. Just be careful this two array could be in different size. '
    );
}
